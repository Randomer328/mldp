...
banner_image = "bannerimage.png"  
city_sel = "city_sel.png"
city_notsel = "city_notsel.png"
rural_sel = "rural_sel.png"
rural_notsel = "rural_notsel.png"
suburb_sel = "suburb_sel.png"
suburb_notsel = "suburb_notsel.png"
...
if st.button("Predict GPA"):
    ...
    # Display the result
    # Display the prediction result with better styling
    st.markdown(
        """
        <style>
        .gpa-card {
    ...
    # Display the predicted GPA in a styled box
...
for i, category in enumerate(gpa_categories):
    if cols[i].button(category):  # Create a button in each column
    ...
    info_card = f"""
        <div style="background-color: transparent; padding: 20px; border-radius: 10px; border: 2px solid rgba(255, 255, 255, 0.4); box-shadow: 0 4px 8px rgba(255, 255, 255, 0.4);">
            ...
            <ul style="list-style-type: none; padding: 0; color:white;">
                ...
                <li><b>Free Time (1-5):</b> {persona_other_features[4]}</li>
                <li><b>GoOut (1-5):</b> {persona_other_features[5]}</li>
            </ul>
        </div>
    """
...
# Add space before the predict button
...
if st.button("Predict GPA"):
    ...
    st.write("Prediction functionality will go here.")